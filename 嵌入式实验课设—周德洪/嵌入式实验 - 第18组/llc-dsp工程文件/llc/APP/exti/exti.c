...
void EXTI1_Init(void)
{
	...
	EALLOW;
	//KEY端口配置
	GpioCtrlRegs.GPAMUX1.bit.GPIO12=0;//一路
	...
	GpioDataRegs.GPBCLEAR.bit.GPIO48=1;//初始置位
	EDIS;
	...
	PieVectTable.XINT1 = &EXTI1_IRQn;//指定中断服务函数地址
	EDIS;   // EDIS的意思是不允许修改被保护的寄存器

	PieCtrlRegs.PIEIER1.bit.INTx4 = 1;          // 使能PIE组1的INT4，为XINT1
...
interrupt void EXTI1_IRQn(void)
{
	...
	PieCtrlRegs.PIEACK.bit.ACK1=1;//中断结束ACK要清0
}
